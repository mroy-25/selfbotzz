...
const help = (db, totalchat, ispublic, timee, date, dateIslamic, hit, ucselamat, runtime, run, prefix, wa_version, mcc, mnc, os_version, device_manufacturer, device_model, process, baterai, ttag, isprefix, shep) => { 
batre = baterai.baterai
isday = baterai.cas == true ? "Charging ⚡" : "Not Charged"
ispowersave = baterai.powersave == true ? "Aktif" : "Nonaktif"
const shape = '*›*'
db.showdata('error').then(res => {
