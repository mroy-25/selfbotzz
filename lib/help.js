...
${shape} ${prefix}searchmusic <reply audio>
...
${shape} ${prefix}ptl <username tiktok>
${shape} ${prefix}tourl
...
${shape} ${prefix}trendtweet <country>
...
${shape} ${prefix}shorturl <link|costum(optional)>
...
${shape} ${prefix}getsticker <nama cmd>
${shape} ${prefix}tagme
${shape} ${prefix}wa.me
