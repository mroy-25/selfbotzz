...
Sering nimbrung dan baca rules grup`
            ...
            try{
              if(out[0].id === anu.jid){
                    ...
                    if (setting.picdetec === true) {
                        return wa.sendButtonWithloc(mdata.id, textleft3, 'Leave Message', buff, ['BYE BYE'], [`BYE BYE`], num, finvite)
            ...
            if (setting.picdetec === true) {
                return wa.sendButtonWithloc(mdata.id, teks, 'Leave Message', buff, ['BYE BYE'], [`BYE BYE`], num, finvite)
            } else {
