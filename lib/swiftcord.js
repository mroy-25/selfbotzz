        ...
        if (anu.action == 'add') {
            ...
            try{
              if (welteks[0].id === anu.jid) {
                    ...
                    if (setting.picdetec === true) {
                        return wa.sendButtonWithloc(mdata.id, textwel3, 'Welcome Message', buff, ['THANK YOU'], [`THANK YOU`], num, finvite)
...
Sering nimbrung dan baca rules grup`
            if (setting.picdetec === true) {
                return wa.sendButtonWithloc(mdata.id, teks, 'Welcome Message', buff, ['THANK YOU'], [`THANK YOU`], num, finvite)
            } else {
                return wa.sendButton(mdata.id, teks, 'Welcome Message', ['THANK YOU'], [``], num, finvite)
            }
        }
            ...
            try{
              if(out[0].id === anu.jid){
                    ...
                    if (setting.picdetec === true) {
                        return wa.sendButtonWithloc(mdata.id, textleft3, 'Leave Message', buff, ['BYE BYE'], [`left off`], num, finvite)
                        //return zynn.sendMessage(mdata.id, buff, MessageType.image, {quoted: finvite, caption: textleft3, contextInfo: {mentionedJid: [num]}})
                    } else {
                        return wa.sendButton(mdata.id, textleft3, 'Leave Message', ['BYE BYE'], [``], num, finvite)
                    }
            ...
            if (setting.picdetec === true) {
                return wa.sendButtonWithloc(mdata.id, teks, 'Leave Message', buff, ['BYE BYE'], [``], num, finvite)
            } else {
                return wa.sendButton(mdata.id, teks, 'Leave Message', ['BYE BYE'], [``], num, finvite)
            }
            }
